...
namespace TheBugTracker.Controllers
{
    public class TicketStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Status")] TicketStatus ticketStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Status")] TicketStatus ticketStatus)
        {
